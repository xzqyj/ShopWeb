...
<div class="header_top">
  <div class="container">
     ...
     <div class="header-top-left">
			 ...
			 <div class="cssmenu">
				<ul>
					<li class="active"><a href="">我的宝贝</a></li> 
					<li><a href="">我的收藏</a></li>
					<li><a href="">我的订单</a></li> 
...
<div class="men">
	<div class="container">
	    <div class="grid_2">
			<c:forEach items="${requestScope.mysaves}" var="mysaves">
			<div class="col-md-3 span_6">
			  <div class="box_inner">
				<img src="images/${mysaves.goodPicture}" class="img-responsive" alt=""/>
				 <div class="sale-box"> </div>
				 <div class="desc">
				 	<h3>${mysaves.goodName }</h3>
				 
				 	<ul class="list2">
				 	  <li class="list2_right"><span class="m_2"><a href="deleteSave?goodname=${mysaves.goodName}" class="link1">删除商品</a></span></li>
				 	 <li class="list2_left"><span class="m_1"><a href="" class="link">立即购买</a></span></li>
				 	  <div class="clearfix"> </div>
				 	</ul>
