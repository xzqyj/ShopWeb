  ...
  <div class="container">
     ...
     <div class="header-top-left">
			  <div class="cssmenu" style="margin-left: 0 px">
					...
					<li><a >欢迎[${sessionScope.user.userName}]访问</a></li>
			 ...
			 <div class="cssmenu">
				<ul>
					<li class="active"><a href="myShopcart?username=${user.userName}">我的宝贝</a></li> 
					
					<li><a href="mySave?username=${user.userName}">我的收藏</a></li> 
					<li><a href="myOrder?username=${user.userName}">我的订单</a></li>
				</ul>
			</div>
			<div class="clearfix"></div>
   </div>
...
<div class="content_top">
	<div class="container">
		...
		<div class="sellers_grid">
			<ul class="sellers">
				<i class="star"> </i>
				<li class="sellers_desc"><h2>全部商品</h2></li>
				<div class="clearfix"> </div>
			</ul>
		</div>						
		<div class="grid_2">
			...
			<div class="col-md-3 span_6">
			  <div class="box_inner">
				<a href="goodDetail?goodname=${goods.goodName}"><img src="images/${goods.goodPicture}" href="main" class="img-responsive" alt=""/></a>
				 <div class="sale-box"> </div>
				 <div class="desc">
				 	<h3>${goods.goodName }</h3>
				 	<h4>${goods.goodPrice }</h4>
				 	<ul class="list2">
				 	  <li class="list2_left"><span class="m_1"><a href="addShopcart?goodid=${goods.goodId}&goodname=${goods.goodName}
				 	  &username=${user.userName}&goodprice=${goods.goodPrice}&goodpicture=${goods.goodPicture}" class="link">加入购物车</a></span></li>
				 	  <li class="list2_right"><span class="m_2"><a href="addSave?goodname=${goods.goodName}&username=${user.userName}
				 	  &goodpicture=${goods.goodPicture}&goodnum='1'" class="link1">收藏商品</a></span></li>
				 	  <div class="clearfix"> </div>
				 	</ul>
				 	<div class="heart"> </div>
				 </div>
