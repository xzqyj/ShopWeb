	...
	<div class="container">
	    <div class="grid_2">
			...
			<div class="col-md-3 span_6">
			  <div class="box_inner">
				<img src="images/${orders.goodPicture}" class="img-responsive" alt=""/>
				 <div class="sale-box"> </div>
				 <div class="desc">
				 	<h3>商品名称：${orders.goodName }</h3>
				 	<h4>商品价格：${orders.goodPrice }</h4>
				 	<h4><a href="" ></a>商品数量：${orders.goodNum}</h4>
				 	<h4><a href="" ></a>订单状态：${orders.orderStatus}</h4>
				 	<ul class="list2">
				 	  
				 	 <li class="list2_left"><span class="m_1"><a href="" class="link">确认收货</a></span></li>
				 	  <li class="list2_right"><span class="m_2"><a href="evaluation?id=${orders.id}" class="link1">订单评价</a></span></li>
				 	  <div class="clearfix"> </div>
				 	</ul>
